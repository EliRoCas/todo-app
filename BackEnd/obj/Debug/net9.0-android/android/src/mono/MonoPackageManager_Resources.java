...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "BackEnd.dll" comes first in this list. */
		"BackEnd.dll",
		"GoogleGson.dll",
		"Interop.Controllers.dll",
		"Interop.Db.Abstractions.dll",
		"Interop.Db.Telegram.dll",
		"Interop.Maui.dll",
		"Interop.Observable.dll",
